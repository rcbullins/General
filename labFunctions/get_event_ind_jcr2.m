function [ i_cross, data_tmp ] = get_event_ind_jcr2(data_dir,fname,nchan,chan2scan,thresh,invert )
...
for i = 1:n_block
    ...
    for j = 1:length(chan2scan)
        ...
        data_tmp(j,:) = load_bin_single_channel('int16',[data_dir '/' fname],nchan,chan2scan(j),i_offset,i_step);
